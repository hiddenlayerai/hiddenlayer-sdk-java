    ...
    fun scanFile(options: ScanFileOptions): ScanReport {
        ...
        try {
            ...
            client
                ...
                .upload()
                .completeAll(
                    com.hiddenlayer_sdk.api.models.scans.upload.UploadCompleteAllParams.builder()
                        .scanId(scanId)
                        .build()
                )
    ...
    private fun uploadFile(scanId: String, filePath: Path) {
        ...
        val upload =
            client
                ...
                .file()
                .add(
                    com.hiddenlayer_sdk.api.models.scans.upload.file.FileAddParams.builder()
                        .scanId(scanId)
                        .fileName(fileName)
        ...
        client
            ...
            .file()
            .complete(
                com.hiddenlayer_sdk.api.models.scans.upload.file.FileCompleteParams.builder()
                ...
                client.scans().upload().start(uploadStartParams).thenCompose { uploadStart ->
                    ...
                    uploadFileAsync(scanId, file.toPath()).thenCompose {
                        ...
                        client
                            ...
                            .upload()
                            .completeAll(
                                com.hiddenlayer_sdk.api.models.scans.upload.UploadCompleteAllParams
                                    .builder()
                                    .scanId(scanId)
                                    .build()
                            )
                    ...
                    .thenCompose { upload ->
                        ...
                        CompletableFuture.allOf(*partFutures.toTypedArray()).thenCompose {
                            ...
                            client
                                ...
                                .file()
                                .complete(
                                    com.hiddenlayer_sdk.api.models.scans.upload.file
                                        .FileCompleteParams
                                        .builder()
                                        .fileId(upload.uploadId())
                                        .scanId(scanId)
