...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): JobListParams =
            JobListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is JobListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "JobListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
