...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ResultListFilesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ResultListFilesParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ResultListFilesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(resultListFilesParams: ResultListFilesParams) = apply {
            scanId = resultListFilesParams.scanId
            cursor = resultListFilesParams.cursor
            hasDetections = resultListFilesParams.hasDetections
            pageSize = resultListFilesParams.pageSize
            additionalHeaders = resultListFilesParams.additionalHeaders.toBuilder()
            additionalQueryParams = resultListFilesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ResultListFilesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ResultListFilesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResultListFilesParams &&
            scanId == other.scanId &&
            cursor == other.cursor &&
    ...
    override fun toString() =
        "ResultListFilesParams{scanId=$scanId, cursor=$cursor, hasDetections=$hasDetections, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
