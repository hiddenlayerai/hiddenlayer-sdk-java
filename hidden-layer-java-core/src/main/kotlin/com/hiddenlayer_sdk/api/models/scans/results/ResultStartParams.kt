...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResultStartParams].
         *
    ...
    /** A builder for [ResultStartParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(resultStartParams: ResultStartParams) = apply {
            pathScanId = resultStartParams.pathScanId
            hasDetections = resultStartParams.hasDetections
            scanReport = resultStartParams.scanReport
            additionalHeaders = resultStartParams.additionalHeaders.toBuilder()
            additionalQueryParams = resultStartParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ResultStartParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResultStartParams && pathScanId == other.pathScanId && hasDetections == other.hasDetections && scanReport == other.scanReport && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ResultStartParams{pathScanId=$pathScanId, hasDetections=$hasDetections, scanReport=$scanReport, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
