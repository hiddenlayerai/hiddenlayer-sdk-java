...
-keepclassmembers class * extends com.hiddenlayer_sdk.api.core.BaseSerializer {
    <init>();
}
-keepclassmembers class * extends com.hiddenlayer_sdk.api.core.BaseDeserializer {
    <init>();
}
