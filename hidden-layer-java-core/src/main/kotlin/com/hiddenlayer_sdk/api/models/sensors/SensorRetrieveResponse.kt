...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorRetrieveResponse: SensorRetrieveResponse) = apply {
            ...
            modelId = sensorRetrieveResponse.modelId
    ...
    override fun toString() =
        "SensorRetrieveResponse{active=$active, createdAt=$createdAt, modelId=$modelId, plaintextName=$plaintextName, sensorId=$sensorId, tags=$tags, tenantId=$tenantId, adhoc=$adhoc, version=$version, additionalProperties=$additionalProperties}"
}
