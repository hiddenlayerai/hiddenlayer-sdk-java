...
package com.hiddenlayer.api.client.okhttp
...
/**
 * A class that allows building an instance of [HiddenLayerClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class HiddenLayerOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [HiddenLayerClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): HiddenLayerClient = builder().fromEnv().build()
    }
    ...
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.hiddenlayer.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [HiddenLayerClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HiddenLayerClient =
