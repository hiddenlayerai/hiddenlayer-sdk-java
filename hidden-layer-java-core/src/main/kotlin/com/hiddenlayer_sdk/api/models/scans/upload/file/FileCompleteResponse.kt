...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileCompleteResponse: FileCompleteResponse) = apply {
            scanId = fileCompleteResponse.scanId
            additionalProperties = fileCompleteResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): FileCompleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileCompleteResponse && scanId == other.scanId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FileCompleteResponse{scanId=$scanId, additionalProperties=$additionalProperties}"
}
