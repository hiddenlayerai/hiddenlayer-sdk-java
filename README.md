...
[![Maven Central](https://img.shields.io/maven-central/v/com.hiddenlayer.api/hiddenlayer-java)](https://central.sonatype.com/artifact/com.hiddenlayer.api/hiddenlayer-java/1.1.0)
[![javadoc](https://javadoc.io/badge2/com.hiddenlayer.api/hiddenlayer-java/1.1.0/javadoc.svg)](https://javadoc.io/doc/com.hiddenlayer.api/hiddenlayer-java/1.1.0)
...
The REST API documentation can be found on [dev.hiddenlayer.ai](https://dev.hiddenlayer.ai). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.hiddenlayer.api/hiddenlayer-java/1.1.0).
...
```kotlin
implementation("com.hiddenlayer.api:hiddenlayer-java:1.1.0")
```
