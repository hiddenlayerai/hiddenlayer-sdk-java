...
internal class ResultListParamsTest {
    ...
    fun create() {
        ResultListParams.builder()
            ...
            .limit(1L)
            .addModelId("string")
            .modelName(ResultListParams.ModelName.builder().contains("contains").eq("eq").build())
            .addModelVersionId("string")
            .offset(0L)
            .scannerVersion("scanner_version")
            .addSeverity("string")
            .sort("sort")
            .source(ResultListParams.Source.builder().eq(ResultListParams.Source.Eq.ADHOC).build())
    ...
    fun headers() {
        val params =
            ResultListParams.builder()
                ...
                .sort("sort")
                .source(
                    ResultListParams.Source.builder().eq(ResultListParams.Source.Eq.ADHOC).build()
                )
                .startTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .addStatus("string")
                .build()
