...
import com.hiddenlayer.sdk.JSON;
...
public class ScanJobInventory extends AbstractOpenApiSchema {
    ...
    public static class ScanJobInventorySerializer extends StdSerializer<ScanJobInventory> {
        ...
        @Override
        public void serialize(ScanJobInventory value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ScanJobInventoryDeserializer extends StdDeserializer<ScanJobInventory> {
        ...
        @Override
        public ScanJobInventory deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (ScanModelDetailsV3.class.equals(Integer.class) || ScanModelDetailsV3.class.equals(Long.class) || ScanModelDetailsV3.class.equals(Float.class) || ScanModelDetailsV3.class.equals(Double.class) || ScanModelDetailsV3.class.equals(Boolean.class) || ScanModelDetailsV3.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ScanModelDetailsV3.class.equals(Integer.class) || ScanModelDetailsV3.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ScanModelDetailsV3.class.equals(Float.class) || ScanModelDetailsV3.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (ScanModelDetailsV3.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ScanModelDetailsV3.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ScanModelIdsV3.class.equals(Integer.class) || ScanModelIdsV3.class.equals(Long.class) || ScanModelIdsV3.class.equals(Float.class) || ScanModelIdsV3.class.equals(Double.class) || ScanModelIdsV3.class.equals(Boolean.class) || ScanModelIdsV3.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ScanModelIdsV3.class.equals(Integer.class) || ScanModelIdsV3.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ScanModelIdsV3.class.equals(Float.class) || ScanModelIdsV3.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (ScanModelIdsV3.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ScanModelIdsV3.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            throw new IOException(String.format("Failed deserialization for ScanJobInventory: %d classes match result, expected 1", match));
        }
