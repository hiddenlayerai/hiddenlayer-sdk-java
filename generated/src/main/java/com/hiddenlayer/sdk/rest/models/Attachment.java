  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRegions() != null) {
      ...
      for (Region _item : getRegions()) {
        if (_item != null) {
          joiner.add(_item.toUrlQueryString(String.format("%sregions%s%s", prefix, suffix,
    ...
    if (getRectangles() != null) {
      ...
      for (Rectangle _item : getRectangles()) {
        if (_item != null) {
          joiner.add(_item.toUrlQueryString(String.format("%srectangles%s%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
      i++;
