 ...
 */
@JsonPropertyOrder({
  Stack.JSON_PROPERTY_MESSAGE,
  Stack.JSON_PROPERTY_FRAMES,
  Stack.JSON_PROPERTY_PROPERTIES
})
    ...
    if (getFrames() != null) {
      for (int i = 0; i < getFrames().size(); i++) {
        if (getFrames().get(i) != null) {
          joiner.add(getFrames().get(i).toUrlQueryString(String.format("%sframes%s%s", prefix, suffix,
