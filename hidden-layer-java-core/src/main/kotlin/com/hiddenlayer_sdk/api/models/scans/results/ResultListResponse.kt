...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResultListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ResultListResponse].
         *
    ...
    fun validate(): ResultListResponse = apply {
        if (validated) {
            return@apply
        }
