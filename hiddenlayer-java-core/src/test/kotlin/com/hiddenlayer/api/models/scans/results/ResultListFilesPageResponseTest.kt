...
internal class ResultListFilesPageResponseTest {

    @Test
    fun create() {
        val resultListFilesPageResponse =
            ResultListFilesPageResponse.builder()
                .first("first")
                .addItem(
                    ScanFileResult.builder()
                        .details(
                            ScanFileResult.Details.builder()
                                ...
                                .fileTypeDetails(
                                    ScanFileResult.Details.FileTypeDetails.GgufFileAttributes
                                        .builder()
                                        .addSubtype("string")
                                        .build()
                                )
        ...
        assertThat(resultListFilesPageResponse.first()).isEqualTo("first")
        assertThat(resultListFilesPageResponse.items())
            .containsExactly(
                ScanFileResult.builder()
                    .details(
                        ScanFileResult.Details.builder()
        ...
        assertThat(resultListFilesPageResponse.next()).isEqualTo("next")
        assertThat(resultListFilesPageResponse.prev()).isEqualTo("prev")
        assertThat(resultListFilesPageResponse.last()).contains("last")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedResultListFilesPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(resultListFilesPageResponse),
                jacksonTypeRef<ResultListFilesPageResponse>(),
            )

        assertThat(roundtrippedResultListFilesPageResponse).isEqualTo(resultListFilesPageResponse)
    }
}
