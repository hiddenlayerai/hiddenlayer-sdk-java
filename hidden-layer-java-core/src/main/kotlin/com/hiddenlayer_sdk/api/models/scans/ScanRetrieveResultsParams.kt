...
private constructor(
    ...
    /** A builder for [ScanRetrieveResultsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scanRetrieveResultsParams: ScanRetrieveResultsParams) = apply {
            scanId = scanRetrieveResultsParams.scanId
            cursor = scanRetrieveResultsParams.cursor
            pageSize = scanRetrieveResultsParams.pageSize
            additionalHeaders = scanRetrieveResultsParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScanRetrieveResultsParams && scanId == other.scanId && cursor == other.cursor && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(scanId, cursor, pageSize, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ScanRetrieveResultsParams{scanId=$scanId, cursor=$cursor, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
