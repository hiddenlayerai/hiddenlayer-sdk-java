...
fun waitForScanResults(client: HiddenLayerClient, scanId: String): ScanReport {
    ...
    while (true) {
        try {
            ...
            if (
                status == com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status.DONE ||
                    status ==
                        com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status.FAILED ||
                    status ==
                        com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status.CANCELED
            ) {
                break
            }
        ...
        .handle { result, exception ->
            when {
                result != null -> {
                    ...
                    if (
                        status ==
                            com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status.DONE ||
                            status ==
                                com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status
                                    .FAILED ||
                            status ==
                                com.hiddenlayer_sdk.api.models.scans.results.ScanReport.Status
                                    .CANCELED
