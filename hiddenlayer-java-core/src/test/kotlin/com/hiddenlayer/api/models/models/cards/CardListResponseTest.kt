    ...
    fun create() {
        val cardListResponse =
            CardListResponse.builder()
                ...
                .modelScanSeverity(CardListResponse.ModelScanSeverity.NOT_AVAILABLE)
        ...
        assertThat(cardListResponse.modelScanSeverity())
            .isEqualTo(CardListResponse.ModelScanSeverity.NOT_AVAILABLE)
