...
interface ReportService {
    ...
    fun create(params: ReportCreateParams) = create(params, RequestOptions.none())

    /** @see [create] */
    fun create(params: ReportCreateParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [ReportService.create].
         */
        @MustBeClosed
        fun create(params: ReportCreateParams): HttpResponse = create(params, RequestOptions.none())
