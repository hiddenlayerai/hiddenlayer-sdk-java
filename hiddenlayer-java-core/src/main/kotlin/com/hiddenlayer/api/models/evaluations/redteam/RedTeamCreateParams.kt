...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun targetModel(): String = body.targetModel()
     ...
     *   server responded with an unexpected value).
     */
    fun executionStrategyType(): Optional<String> = body.executionStrategyType()
     ...
     * type.
     */
    fun _executionStrategyType(): JsonField<String> = body._executionStrategyType()
    ...
    class Builder internal constructor() {
        ...
        /** Execution strategy type */
        fun executionStrategyType(executionStrategyType: String) = apply {
         ...
         *
         * You should usually call [Builder.executionStrategyType] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun executionStrategyType(executionStrategyType: JsonField<String>) = apply {
            body.executionStrategyType(executionStrategyType)
        }
    ...
    private constructor(
        ...
        private val executionStrategyType: JsonField<String>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            executionStrategyType: JsonField<String> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun targetModel(): String = targetModel.getRequired("target_model")
         ...
         *   the server responded with an unexpected value).
         */
        fun executionStrategyType(): Optional<String> =
        ...
        @JsonProperty("execution_strategy_type")
        @ExcludeMissing
        fun _executionStrategyType(): JsonField<String> = executionStrategyType
        ...
        class Builder internal constructor() {
            ...
            private var targetModel: JsonField<String>? = null
            ...
            private var executionStrategyType: JsonField<String> = JsonMissing.of()
            ...
            /** Execution strategy type */
            fun executionStrategyType(executionStrategyType: String) =
                executionStrategyType(JsonField.of(executionStrategyType))

            /**
             * Sets [Builder.executionStrategyType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.executionStrategyType] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun executionStrategyType(executionStrategyType: JsonField<String>) = apply {
            ...
            fun build(): Body =
                Body(
                    ...
                    checkRequired("targetModel", targetModel),
                    attackerMaxGenerationAttempts,
                    attackerModel,
                    evaluationReportModel,
                    executionStrategyType,
        ...
        internal fun validity(): Int =
            (if (name.asKnown().isPresent) 1 else 0) +
                ...
                (if (executionStrategyType.asKnown().isPresent) 1 else 0) +
        ...
        override fun toString() =
            "Body{name=$name, targetModel=$targetModel, attackerMaxGenerationAttempts=$attackerMaxGenerationAttempts, attackerModel=$attackerModel, evaluationReportModel=$evaluationReportModel, executionStrategyType=$executionStrategyType, hlProjectId=$hlProjectId, maxParallelTechniques=$maxParallelTechniques, maxTurns=$maxTurns, nRandomTechniques=$nRandomTechniques, objectiveIds=$objectiveIds, objectiveJudgeModel=$objectiveJudgeModel, promptSetId=$promptSetId, refusalJudgeModel=$refusalJudgeModel, sessionsPerTechnique=$sessionsPerTechnique, targetSystemPrompt=$targetSystemPrompt, additionalProperties=$additionalProperties}"
    }
