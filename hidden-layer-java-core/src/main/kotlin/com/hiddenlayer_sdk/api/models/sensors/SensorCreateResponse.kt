...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SensorCreateResponse && active == other.active && createdAt == other.createdAt && plaintextName == other.plaintextName && sensorId == other.sensorId && tenantId == other.tenantId && version == other.version && adhoc == other.adhoc && tags == other.tags && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SensorCreateResponse{active=$active, createdAt=$createdAt, plaintextName=$plaintextName, sensorId=$sensorId, tenantId=$tenantId, version=$version, adhoc=$adhoc, tags=$tags, additionalProperties=$additionalProperties}"
}
