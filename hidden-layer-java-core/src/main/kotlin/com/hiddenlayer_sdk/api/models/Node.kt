...
private constructor(
    ...
    private val label: JsonField<Message>,
    ...
    private constructor(
        ...
        @JsonProperty("label") @ExcludeMissing label: JsonField<Message> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun label(): Optional<Message> = label.getOptional("label")
     ...
     */
    @JsonProperty("label") @ExcludeMissing fun _label(): JsonField<Message> = label
    ...
    class Builder internal constructor() {
        ...
        private var label: JsonField<Message> = JsonMissing.of()
        ...
        /** A short description of the node. */
        fun label(label: Message) = label(JsonField.of(label))

        /**
         * Sets [Builder.label] to an arbitrary JSON value.
         *
         * You should usually call [Builder.label] with a well-typed [Message] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun label(label: JsonField<Message>) = apply { this.label = label }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** A set of regions relevant to the location. */
            fun annotations(annotations: List<Region>) = annotations(JsonField.of(annotations))

            /**
             * Sets [Builder.annotations] to an arbitrary JSON value.
             *
             * You should usually call [Builder.annotations] with a well-typed `List<Region>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun contextRegion(): Optional<Region> = contextRegion.getOptional("contextRegion")
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.contextRegion] with a well-typed [Region] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    /** A short description of the artifact location. */
                    fun description(description: Message) = description(JsonField.of(description))
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * Sets [Builder.description] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.description] with a well-typed [Message] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun description(description: JsonField<Message>) = apply {
