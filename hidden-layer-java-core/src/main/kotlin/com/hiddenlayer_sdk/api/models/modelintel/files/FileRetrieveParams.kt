...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileRetrieveParams: FileRetrieveParams) = apply {
            sha256 = fileRetrieveParams.sha256
            cursor = fileRetrieveParams.cursor
            pageSize = fileRetrieveParams.pageSize
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileRetrieveParams && sha256 == other.sha256 && cursor == other.cursor && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(sha256, cursor, pageSize, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "FileRetrieveParams{sha256=$sha256, cursor=$cursor, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
