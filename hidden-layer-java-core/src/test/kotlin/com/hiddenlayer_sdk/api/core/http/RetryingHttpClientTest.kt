...
import com.hiddenlayer_sdk.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw HiddenLayerRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            HiddenLayerRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
