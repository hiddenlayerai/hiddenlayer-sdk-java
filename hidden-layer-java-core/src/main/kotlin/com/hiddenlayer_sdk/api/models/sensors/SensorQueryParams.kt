...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && filter == other.filter && orderBy == other.orderBy && orderDir == other.orderDir && pageNumber == other.pageNumber && pageSize == other.pageSize && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(filter, orderBy, orderDir, pageNumber, pageSize, additionalProperties) }
        /* spotless:on */
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Filter && active == other.active && createdAtStart == other.createdAtStart && createdAtStop == other.createdAtStop && plaintextName == other.plaintextName && source == other.source && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(active, createdAtStart, createdAtStop, plaintextName, source, version, additionalProperties) }
        /* spotless:on */
    ...
    class OrderDir @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is OrderDir && value == other.value /* spotless:on */
        }
