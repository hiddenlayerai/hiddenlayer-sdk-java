...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScanFileResult].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scanFileResult: ScanFileResult) = apply {
            details = scanFileResult.details
            detections = scanFileResult.detections.map { it.toMutableList() }
            endTime = scanFileResult.endTime
            fileInstanceId = scanFileResult.fileInstanceId
            fileLocation = scanFileResult.fileLocation
            seen = scanFileResult.seen
            startTime = scanFileResult.startTime
            status = scanFileResult.status
            advisories = scanFileResult.advisories.map { it.toMutableList() }
            compliance = scanFileResult.compliance
            fileError = scanFileResult.fileError.map { it.toMutableList() }
            additionalProperties = scanFileResult.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScanFileResult].
         *
     ...
     *   expected type.
     */
    fun validate(): ScanFileResult = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = fileTypeDetails.accept(new FileTypeDetails.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitGgufFileAttributes(GgufFileAttributes ggufFileAttributes) {
             *         return Optional.of(ggufFileAttributes.toString());
             *     }
             *
             *     // ...
             *
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    ...
                    rdsFileAttributes != null -> visitor.visitRdsFileAttributes(rdsFileAttributes)
            ...
            fun validate(): FileTypeDetails = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        ...
                        override fun visitRdsFileAttributes(rdsFileAttributes: RdsFileAttributes) {
            ...
            /**
             * An interface that defines how to map each variant of [FileTypeDetails] to a value of
             * type [T].
             */
            ...
            internal class Deserializer :
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): FileTypeDetails {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<GgufFileAttributes>())?.let {
                                    FileTypeDetails(ggufFileAttributes = it, _json = json)
                                },
                                tryDeserialize(node, jacksonTypeRef<KerasFileAttributes>())?.let {
                                    FileTypeDetails(kerasFileAttributes = it, _json = json)
                                },
                                tryDeserialize(node, jacksonTypeRef<NumpyFileAttributes>())?.let {
            ...
            internal class Serializer : BaseSerializer<FileTypeDetails>(FileTypeDetails::class) {
            ...
            private constructor(
                 ...
                 *
                 * Unlike [subtype], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("subtype")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.subtype] with a well-typed `List<String>`
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(kerasFileAttributes: KerasFileAttributes) = apply {
                        pickleModules = kerasFileAttributes.pickleModules.map { it.toMutableList() }
                     ...
                     *
                     * You should usually call [Builder.kerasClassName] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.kerasDateSavedAt] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    fun kerasModule(kerasModule: String) = kerasModule(JsonField.of(kerasModule))
                    ...
                    fun build(): KerasFileAttributes =
                        KerasFileAttributes(
                            checkRequired("pickleModules", pickleModules).map { it.toImmutable() },
                            checkRequired("subtype", subtype).map { it.toImmutable() },
                            kerasClassName,
                            kerasDateSavedAt,
                            kerasModule,
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    fun numpyArrays(numpyArrays: String) = numpyArrays(JsonField.of(numpyArrays))
                    ...
                    fun numpyShape(numpyShape: List<String>) = numpyShape(JsonField.of(numpyShape))

                    /**
                     * Sets [Builder.numpyShape] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.numpyShape] with a well-typed `List<String>`
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
            ...
            private constructor(
                 ...
                 *   unexpected value).
                 */
                fun rdsWriterVersion(): String = rdsWriterVersion.getRequired("rds_writer_version")
                 ...
                 *
                 * Unlike [rdsMinReaderVersion], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("rds_min_reader_version")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(rdsFileAttributes: RdsFileAttributes) = apply {
                        ...
                        additionalProperties = rdsFileAttributes.additionalProperties.toMutableMap()
                    }

                    /** encoding of the RDS file */
                    fun rdsEncoding(rdsEncoding: String) = rdsEncoding(JsonField.of(rdsEncoding))
                     ...
                     *
                     * You should usually call [Builder.rdsVersion] with a well-typed [String] value
                     ...
                     *
                     * You should usually call [Builder.rdsWriterVersion] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.technicalBlogHrefs] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
    ...
    /**
     * An informational advisory associated with a file. Advisories carry guidance about a property
     * of the model (e.g. tokenizer family) that may matter to a downstream consumer, but do not
     * represent a concrete detection.
     */
    class Advisory
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
         ...
         *
         * Unlike [advisoryId], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("advisory_id")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * supported value.
             */
            fun advisoryId(advisoryId: JsonField<String>) = apply { this.advisoryId = advisoryId }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val rationale: JsonField<List<String>>,
        private val status: JsonField<Status>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            rationale: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("status") @ExcludeMissing status: JsonField<Status> = JsonMissing.of(),
        ) : this(rationale, status, mutableMapOf())

        /**
         * @throws HiddenLayerInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        fun rationale(): Optional<List<String>> = rationale.getOptional("rationale")
        ...
        @JsonProperty("rationale")
        @ExcludeMissing
        fun _rationale(): JsonField<List<String>> = rationale
        ...
        class Builder internal constructor() {
            ...
            private var rationale: JsonField<MutableList<String>>? = null
            private var status: JsonField<Status> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(compliance: Compliance) = apply {
                rationale = compliance.rationale.map { it.toMutableList() }
                status = compliance.status
                additionalProperties = compliance.additionalProperties.toMutableMap()
            }

            fun rationale(rationale: List<String>) = rationale(JsonField.of(rationale))

            /**
             * Sets [Builder.rationale] to an arbitrary JSON value.
             *
             * You should usually call [Builder.rationale] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rationale(rationale: JsonField<List<String>>) = apply {
                this.rationale = rationale.map { it.toMutableList() }
            }

            /**
             * Adds a single [String] to [Builder.rationale].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRationale(rationale: String) = apply {
                this.rationale =
                    (this.rationale ?: JsonField.of(mutableListOf())).also {
                        checkKnown("rationale", it).add(rationale)
                    }
            }
            ...
            fun build(): Compliance =
                Compliance(
                    (rationale ?: JsonMissing.of()).map { it.toImmutable() },
                    status,
                    additionalProperties.toMutableMap(),
                )
        }
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (rationale.asKnown().getOrNull()?.size ?: 0) +
                (status.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(rationale, status, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Compliance{rationale=$rationale, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScanFileResult &&
    ...
    override fun toString() =
        "ScanFileResult{details=$details, detections=$detections, endTime=$endTime, fileInstanceId=$fileInstanceId, fileLocation=$fileLocation, seen=$seen, startTime=$startTime, status=$status, advisories=$advisories, compliance=$compliance, fileError=$fileError, additionalProperties=$additionalProperties}"
}
