...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uploadCompleteAllResponse: UploadCompleteAllResponse) = apply {
            scanId = uploadCompleteAllResponse.scanId
            additionalProperties = uploadCompleteAllResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): UploadCompleteAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UploadCompleteAllResponse && scanId == other.scanId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UploadCompleteAllResponse{scanId=$scanId, additionalProperties=$additionalProperties}"
}
